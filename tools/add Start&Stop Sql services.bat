...
reg add "HKEY_CLASSES_ROOT\Directory\shell\startsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0startsql.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Drive\shell\startsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0startsql.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\startsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0startsql.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\shell\stopsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0stopsql.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Drive\shell\stopsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0stopsql.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\stopsql\command" /ve /d "%~sdp0runas.exe \"%~sdp0stopsql.bat\"" /f
