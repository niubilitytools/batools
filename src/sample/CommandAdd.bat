...
reg add "HKEY_CLASSES_ROOT\Drive\shell\%key%\command" /ve /d "%~sdp0runner.exe \"%~sdp0%key%.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\shell\%key%\command" /ve /d "%~sdp0runner.exe \"%~sdp0%key%.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\%key%\command" /ve /d "%~sdp0runner.exe \"%~sdp0%key%.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\LibraryFolder\shell\%key%\command" /ve /d "%~sdp0runner.exe \"%~sdp0%key%.bat\"" /f
...
reg add "HKEY_CLASSES_ROOT\LibraryFolder\Background\shell\%key%\command" /ve /d "%~sdp0runner.exe \"%~sdp0%key%.bat\"" /f
